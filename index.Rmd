...
Introduction nothing is changing?
...
- The data is collected by Seattle Public Library checkouts.

- Why was the data collected? 
- All sorts of reasons but it seems to be the database for checkouts by Seattle Public Library.
...
{r, echo = FALSE, code = readLines("publisherChart.R")}
